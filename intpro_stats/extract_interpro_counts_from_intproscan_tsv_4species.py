...
## returns dictionary with interpro id as key and list as value in [id count,total ids count] format as well as total counts as integer
...
species = ['Tfl','Pfu','Tst','Pde','Pro','Pch','Pdi','ANID','Ani','Ate','Afl','Aor','Afu','Nfi','Acl']
