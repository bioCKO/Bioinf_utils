...
# lf_out = sortout[:-12] + '_rg_dedup_re_sort.vcf'
#
# lfargs = '/usr/local/bin/lofreq call-parallel -f /Users/mjohnpayne/Documents/PhD/wt_genome/pmfa1_annot_scaf.fasta -o '+ lf_out + ' ' + realign_out + ' --pp-threads 6'
#
# subprocess.Popen(lfargs, shell=True).wait()
print 'done'
