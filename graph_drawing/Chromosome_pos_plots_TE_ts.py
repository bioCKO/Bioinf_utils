...
ingff = open('/Users/mjohnpayne/Documents/PhD/wt_genome/tsta1_working_models_fix.gff3','r')

#inTE = open('/Users/mjohnpayne/Documents/PhD/Chromosome_plots/TE/pmfa1_annot_scaf_repeats.gff','r')

inTE = open('/Volumes/MP_HD/repDNA_data/repeatmasker/Ts_all_genome.fasta.out.gff','r')
...
entries = []
lengths = []
for i in SeqIO.parse("/Volumes/MP_HD/repDNA_data/Ts_all_genome.fasta", "fasta"):
    genome[i.id] = i
...
chr_diagram.draw('/Users/mjohnpayne/Documents/PhD/Chromosome_plots/ts_TE/'+ tetype + '_chromosome_positions.pdf', tetype + '_positions')
