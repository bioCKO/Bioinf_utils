...
#plt.show()
plt.savefig('/Volumes/MP_HD/Pm_Ts_Tf_Pf_comparison/Eurotiomycetidae_proteomes/RNA_Seq_data_mapped_to_genome/phage_RPKM_median_50k.pdf',dpi=600)
