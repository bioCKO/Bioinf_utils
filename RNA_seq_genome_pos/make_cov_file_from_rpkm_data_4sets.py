...
cov4 = make_cov_dict(RPKM_index4)

print cov['59'][1200:1300]
print cov2['59'][1200:1300]
print cov3['59'][1200:1300]
print cov4['59'][1200:1300]
...
for contig in position:
    ...
    if avg_depth == 0:
        ...
        avg_depth = avg_depth
    y_min = 0
    y_max = y_max = max([max(values[contig]),max(val2[contig]),max(val3[contig]),max(val4[contig])])
...
#plt.show()
plt.savefig('/Volumes/MP_HD/Pm_Ts_Tf_Pf_comparison/Eurotiomycetidae_proteomes/RNA_Seq_data_mapped_to_genome/phage_RPKM_mean_100k.pdf',dpi=600)
